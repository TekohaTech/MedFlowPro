...
export function ReportsStatsCards({
  ...
  const typeCards = [
    { label: 'Total', value: totalInvoiced, icon: TrendingUp, color: 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' },
    { label: 'Guardias', value: totalGuardias, icon: Clock, color: 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400' },
    { label: 'Proced.', value: totalProcedimientos, icon: Stethoscope, color: 'bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400' },
    { label: 'Intercons.', value: totalInterconsultas, icon: UserCheck, color: 'bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400' },
    { label: 'Extras', value: totalExtras, icon: FileText, color: 'bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400' },
  ];
